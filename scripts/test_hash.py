...
contract_hash = Web3.toBytes(
    0x42fdcbc6afbdc15d7723dcf55625d3c04b408ce3fbcd34f5ecaef1cbc5a4eb14
)
...
hash2 = Web3.solidityKeccak(['uint256', 'address', 'uint256'], (index, account, amount))
hash3 = Web3.solidityKeccak(['uint256', 'address', 'uint256'], (index+1, account, amount))
sum1 = Web3.solidityKeccak(["bytes32", "bytes32"], (hash2, hash3))
sum2 = Web3.keccak(hash2 + hash3)

print(hash2.hex())
print(hash3.hex())
print(sum1.hex())
print(sum1 == sum2)
print(contract_hash == sum1)
